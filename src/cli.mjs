...
// the local database.
//
// Every slug here is checked against OpenRouter's live catalog (`/api/v1/models`)
// rather than against a model page that outlives the endpoint it names - a slug
// retired upstream is a connection test that 400s with "No endpoints found", which
// is what `mistralai/codestral-2501` became.
//
// The Claude entries are the path this integration is built for: Claude Code talking
// to OpenRouter's Anthropic endpoint needs no translation, so these are what a run
// should reach for and what the connection test defaults to (the list is ordered by
// name, and `claude-*` sorts first). The rest are best-effort - they are reached
// through that same Anthropic skin, which has to translate another vendor's tool
// calls, so a model whose calls it cannot translate fails mid-run rather than at
// connection time. They carry `coding` alone because of it: an implementer executes
// a plan the routing tier already wrote, while planning and review stay on the
// models whose protocol is not in question.
const OPENROUTER_MODELS = [
  { id: 'openrouter:anthropic/claude-opus-5', name: 'claude-opus-5', displayName: 'Claude Opus 5', providerModelId: 'anthropic/claude-opus-5', invocationModelId: 'anthropic/claude-opus-5', capabilities: ['planning', 'coding', 'review', 'repair'], speed: 7, quality: 10, contextLength: 1000000, reasoning: 'frontier', toolUse: true, streaming: true, inputCostPerMTok: 5, outputCostPerMTok: 25, cacheReadCostPerMTok: 0.5, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
  { id: 'openrouter:anthropic/claude-opus-4.8', name: 'claude-opus-4.8', displayName: 'Claude Opus 4.8', providerModelId: 'anthropic/claude-opus-4.8', invocationModelId: 'anthropic/claude-opus-4.8', capabilities: ['planning', 'coding', 'review', 'repair'], speed: 6, quality: 10, contextLength: 1000000, reasoning: 'frontier', toolUse: true, streaming: true, inputCostPerMTok: 5, outputCostPerMTok: 25, cacheReadCostPerMTok: 0.5, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
  { id: 'openrouter:anthropic/claude-sonnet-5', name: 'claude-sonnet-5', displayName: 'Claude Sonnet 5', providerModelId: 'anthropic/claude-sonnet-5', invocationModelId: 'anthropic/claude-sonnet-5', capabilities: ['planning', 'coding', 'review', 'repair'], speed: 9, quality: 9, contextLength: 1000000, reasoning: 'strong', toolUse: true, streaming: true, inputCostPerMTok: 2, outputCostPerMTok: 10, cacheReadCostPerMTok: 0.2, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
  { id: 'openrouter:anthropic/claude-sonnet-4.6', name: 'claude-sonnet-4.6', displayName: 'Claude Sonnet 4.6', providerModelId: 'anthropic/claude-sonnet-4.6', invocationModelId: 'anthropic/claude-sonnet-4.6', capabilities: ['planning', 'coding', 'review', 'repair'], speed: 8, quality: 9, contextLength: 1000000, reasoning: 'strong', toolUse: true, streaming: true, inputCostPerMTok: 3, outputCostPerMTok: 15, cacheReadCostPerMTok: 0.3, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
  { id: 'openrouter:anthropic/claude-haiku-4.5', name: 'claude-haiku-4.5', displayName: 'Claude Haiku 4.5', providerModelId: 'anthropic/claude-haiku-4.5', invocationModelId: 'anthropic/claude-haiku-4.5', capabilities: ['planning', 'coding', 'review', 'repair'], speed: 10, quality: 7, contextLength: 200000, reasoning: 'moderate', toolUse: true, streaming: true, inputCostPerMTok: 1, outputCostPerMTok: 5, cacheReadCostPerMTok: 0.1, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
  { id: 'openrouter:google/gemini-2.5-pro', name: 'gemini-2.5-pro', displayName: 'Gemini 2.5 Pro', providerModelId: 'google/gemini-2.5-pro', invocationModelId: 'google/gemini-2.5-pro', capabilities: ['coding'], speed: 8, quality: 9, contextLength: 1000000, reasoning: 'strong', toolUse: true, streaming: true, inputCostPerMTok: 1.25, outputCostPerMTok: 10, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
  { id: 'openrouter:google/gemini-2.5-flash', name: 'gemini-2.5-flash', displayName: 'Gemini 2.5 Flash', providerModelId: 'google/gemini-2.5-flash', invocationModelId: 'google/gemini-2.5-flash', capabilities: ['coding'], speed: 10, quality: 8, contextLength: 1000000, reasoning: 'moderate', toolUse: true, streaming: true, inputCostPerMTok: 0.15, outputCostPerMTok: 0.6, billingMode: 'api', pricingSource: 'OpenRouter pricing', pricingUpdatedAt: '2026-09-24' },
